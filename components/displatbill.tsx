								...
								<div>
									<div
										...
										<p
											...
											Price &nbsp;&emsp;&emsp;&emsp; Qty &nbsp;&emsp;&emsp;
											Amount
										</p>
										<span
											style={{
							...
							<CardBody>
								<>
									...
									<div style={{ fontSize: '18px', marginTop: '5px' }}>
										Balance: {Math.max(0, amount - data.cost).toFixed(2)}
										LKR
									</div>
									<FormGroup
										id='amount'
