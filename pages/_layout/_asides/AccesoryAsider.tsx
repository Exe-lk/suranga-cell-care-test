...
import { addminPagesMenu, AccessoryBillKeeper, logoutmenu } from '../../../menu';
...
const DefaultAside = () => {
	...
	useEffect(() => {
		const validateUser = async () => {
			...
			if (email == 'Accessory sales assitant') {
	...
	return (
		<Aside>
			...
			<AsideBody>
				...
				<Navigation menu={AccessoryBillKeeper} id='aside-dashboard' />
