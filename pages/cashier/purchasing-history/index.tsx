...
const Index: React.FC = () => {
	...
	const [searchDate, setSearchDate] = useState<string>(formattedDate);
	...
	useEffect(() => {
		const fetchData = async () => {
			...
			try {
				// const dataCollection = collection(firestore, 'accessorybill'),where('date', '==', date)
				 const q = query(
					collection(firestore, 'accessorybill'),
							...
							<Card stretch>
								<CardTitle className='d-flex justify-content-between align-items-center m-4'>
									<div className='mt-2 mb-4'>
										...
										<input
    type="date"
    onChange={(e) => setSearchDate(formatToMMDDYYYY(e.target.value))}
    value={formatToYYYYMMDD(searchDate)}
														...
														<tr style={{ cursor: 'pointer' }}>
															...
															<td style={{ textAlign: 'right' }}>
																{new Intl.NumberFormat(
																	'en-US',
																).format(Number(order.totalDiscount))}
															</td>
															<td style={{ textAlign: 'right' }}>
																{new Intl.NumberFormat(
																	'en-US',
																				...
																				(
																					...
																					<tr
																						...
																						<td
																							...
																							{new Intl.NumberFormat(
																								'en-US',
																							).format(Number(data.discount/data.quantity ),
																							)}
																						</td>
																						<td>
																							{
																						...
																						<td
																							...
																							{new Intl.NumberFormat(
																								...
																								Number((data.sellingPrice *data.quantity)-data.discount),
																							)}
																						</td>
																					</tr>
																				),
